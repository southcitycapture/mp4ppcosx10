#!/usr/bin/env python3
"""M34 (PLAN.md 49), from M31's compare_m31.py: regenerate port/docs/gallery/compare.html
...
is which event) are read from ~/mp4-sweep-work/picks/.
    ...
    compare_m34.py [--gallery-dir DIR]     (default: port/docs/gallery next to this file)
"""
...
TAGS = ['m34', 'm31', 'm30']   # newest first; 'fix' (the M26 fix build) is the floor
tagv = {}
for t in TAGS:
    tagv[t] = {}
...
<title>Mario Party 4 PowerPC port: the port beside the console, every minigame (M26b, M30, M31, M34)</title>
